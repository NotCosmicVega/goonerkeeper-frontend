...
import { type SavedContent, useSavedContent } from "../../hooks/useSavedContent"
...
const EditContentModal: React.FC<EditContentModalProps> = ({ content, onClose, existingTags }) => {
  ...
  const { updateContent } = useSavedContent()
